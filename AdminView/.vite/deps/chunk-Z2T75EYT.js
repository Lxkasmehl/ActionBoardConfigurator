...
function useTheme(defaultTheme5 = null) {
  const contextTheme = React17.useContext(ThemeContext);
...
function useMediaQueryOld(query, defaultMatches, matchMedia, ssrMatchMedia, noSsr) {
  const [match, setMatch] = React20.useState(() => {
    if (noSsr && matchMedia) {
...
function useMediaQueryNew(query, defaultMatches, matchMedia, ssrMatchMedia, noSsr) {
  const getDefaultSnapshot = React20.useCallback(() => defaultMatches, [defaultMatches]);
  const getServerSnapshot = React20.useMemo(() => {
    if (noSsr && matchMedia) {
      return () => matchMedia(query).matches;
    }
  ...
  const [getSnapshot, subscribe] = React20.useMemo(() => {
    if (matchMedia === null) {
      return [getDefaultSnapshot, () => () => {
      }];
    }
...
var RtlContext = React24.createContext();
...
var PropsContext = React25.createContext(void 0);
...
function useCurrentColorScheme(options) {
  ...
  const modeStorage = React28.useMemo(() => storageManager == null ? void 0 : storageManager({
    key: modeStorageKey,
    storageWindow
  }), [storageManager, modeStorageKey, storageWindow]);
  const lightStorage = React28.useMemo(() => storageManager == null ? void 0 : storageManager({
    key: `${colorSchemeStorageKey}-light`,
    storageWindow
  }), [storageManager, colorSchemeStorageKey, storageWindow]);
  const darkStorage = React28.useMemo(() => storageManager == null ? void 0 : storageManager({
...
function createCssVarsProvider(options) {
  ...
  const useColorScheme = () => React29.useContext(ColorSchemeContext) || defaultContext;
  ...
  const Grid2 = React31.forwardRef(function Grid3(inProps, ref) {
    ...
    return (0, import_jsx_runtime12.jsx)(GridRoot, {
      ...
      children: React31.Children.map(children, (child) => {
        var _a;
        if (React31.isValidElement(child) && isMuiElement(child, ["Grid"]) && container && child.props.container) {
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-Z2T75EYT.js.map
