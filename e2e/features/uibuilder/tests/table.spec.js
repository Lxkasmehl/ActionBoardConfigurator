  ...
  test('fill table with fetched data without dataPicker', async ({
    ...
    await verifyTableData(
      ...
      [
        ...
        '',
        '',
        /^(ppppqui|ttttrec1|pppprec1)$/,
        '',
        '',
        '',
        /^(ttttrec2|ttttrec1|pppprec1|pppprec2)$/,
        '',
        '',
        '',
      ],
  ...
  test('fill table with fetched data with dataPicker', async ({
    ...
    await verifyTableData(
      ...
      [
        ...
        '',
        '',
        /^(ttttqui|ppppqui|ttttrec1|pppprec1)$/,
        '',
        '',
        '',
  ...
  test('fill table with fetched data from different entities and connect via relation and delete column', async ({
    ...
    await verifyTableData(
      ...
      [
        ...
        'Landsberger Str. 110',
        '5660',
        /^(ttttqui|ppppqui|pppprec1|ttttrec1)$/,
        'Landsberger Str. 110',
        /^(4959|4955|4295)$/,
        /^(ttttrec1|pppprec1|ttttrec2)$/,
        /^(Landsberger Str. 110|Zürichbergstr. 7)$/,
        /^(4295|4291|4321)$/,
      ],
      testInfo,
    );
